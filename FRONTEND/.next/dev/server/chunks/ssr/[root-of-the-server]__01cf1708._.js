...
function AuthProvider({ children }) {
    ...
    const login = async (email, password)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post("/auth/login/", {
            email,
            password
        });
    ...
    const register = async (email, username, password, password_confirm)=>{
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post("/auth/register/", {
            email,
            username,
            password,
            password_confirm
...
//# sourceMappingURL=%5Broot-of-the-server%5D__01cf1708._.js.map