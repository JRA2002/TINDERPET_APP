...
function AuthProvider({ children }) {
    ...
    const login = async (email, password)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post("/auth/login/", {
            email,
            password
        });
    ...
    const register = async (email, username, password, password_confirm)=>{
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post("/auth/register/", {
            email,
            username,
            password,
            password_confirm
    ...
    const refreshToken = async ()=>{
        ...
        try {
            const refresh = localStorage.getItem("refresh_token");
            if (!refresh) return;
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post("/auth/refresh/", {
                refresh
            });
            const { access } = response.data;
            localStorage.setItem("access_token", access);
...
//# sourceMappingURL=_592fbb36._.js.map